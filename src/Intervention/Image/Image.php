 ...
 * @method \Intervention\Image\Image colorizeToRGBA(int $red, int $green, int $blue, int $alpha = 0)                                                          Change the RGBA color values of the current image on the given channels red, green, blue and alpha. The input values are validated so you have to include parameters from 0 to 255 for the RGB and 0 (no transparency) to 100 (total transparency - invisible) for alpha.
