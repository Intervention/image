 ...
 * @method \Intervention\Image\Comparison compare(\Intervention\Image\Image $otherImage, integer $threshold, \Intervention\Image\AbstractColor $highlightColor, boolean $resizeCanvas) Compare two images with each other. Returns Comparison object with an integer score and an image diff.
