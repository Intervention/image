...
class FaceCommand extends \Intervention\Image\Commands\AbstractCommand
{
    ...
    public function execute($image)
    {
        ...
        // crop image core
        $this->modify($image, 0, 0, $position->x, $position->y, $cropped->width, $cropped->height, $cropped->width, $cropped->height);
        return true;
    }
