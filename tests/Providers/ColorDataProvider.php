...
class ColorDataProvider
{
    public static function rgbArray(): Generator
    {
        ...
        yield [[255, 0, 55, 255], [255, 0, 55, 255]];
    }
    ...
    public static function rgbString(): Generator
    {
        ...
        yield [['rgba(255, 0, 55)'], [255, 0, 55, 255]];
        yield [['rgba(255, 0, 55, 1)'], [255, 0, 55, 255]];
        yield [['srgba(255, 0, 55)'], [255, 0, 55, 255]];
    ...
    {
        yield [['ff5500'], [255, 85, 0, 255]];
        yield [['cccccc'], [204, 204, 204, 255]];
        yield [['ff5500cc'], [255, 85, 0, 204]];
        yield [['cccccccc'], [204, 204, 204, 204]];
        yield [['#ff5500'], [255, 85, 0, 255]];
        yield [['#cccccc'], [204, 204, 204, 255]];
        yield [['#ff5500cc'], [255, 85, 0, 204]];
        yield [['#cccccccc'], [204, 204, 204, 204]];
        yield [['f50'], [255, 85, 0, 255]];
        yield [['ccc'], [204, 204, 204, 255]];
        yield [['f50c'], [255, 85, 0, 204]];
        yield [['cccc'], [204, 204, 204, 204]];
        yield [['#f50'], [255, 85, 0, 255]];
        yield [['#ccc'], [204, 204, 204, 255]];
        yield [['#f50c'], [255, 85, 0, 204]];
        yield [['#cccc'], [204, 204, 204, 204]];
