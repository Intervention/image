...
final class CropModifierTest extends GdTestCase
{
    public function testModify(): void
    {
        ...
        $this->assertColor(255, 0, 0, 1, $image->colorAt(100, 100));
        $this->assertColor(255, 0, 0, 1, $image->colorAt(190, 190));
    }
    ...
    public function testModifyExtend(): void
    {
        ...
        $this->assertColor(255, 0, 0, 1, $image->colorAt(9, 9));
        $this->assertColor(0, 0, 255, 1, $image->colorAt(16, 16));
        $this->assertColor(0, 0, 255, 1, $image->colorAt(445, 16));
    ...
    public function testModifySinglePixel(): void
    {
        ...
        $this->assertColor(255, 0, 0, 1, $image->colorAt(1, 1));
        $this->assertColor(255, 255, 0, 1, $image->colorAt(2, 2));
    }
    ...
    public function testHalfTransparent(): void
    {
        ...
        $this->assertColor(0, 0, 255, 0.33070866141732, $image->colorAt(5, 5));
        $this->assertColor(0, 0, 255, 0.33070866141732, $image->colorAt(16, 5));
        $this->assertColor(0, 0, 255, 0.33070866141732, $image->colorAt(30, 5));
        $this->assertColor(0, 0, 255, 0.33070866141732, $image->colorAt(5, 16));
        $this->assertColor(255, 0, 0, 1, $image->colorAt(16, 16));
        $this->assertColor(0, 0, 255, 0.33070866141732, $image->colorAt(30, 16));
        $this->assertColor(0, 0, 255, 0.33070866141732, $image->colorAt(5, 30));
        $this->assertColor(0, 0, 255, 0.33070866141732, $image->colorAt(16, 30));
        $this->assertColor(0, 0, 255, 0.33070866141732, $image->colorAt(30, 30));
    }
    ...
    public function testMergeTransparentBackgrounds(): void
    {
        ...
        $this->assertEquals(3, $image->width());
        $this->assertEquals(3, $image->height());
        $this->assertColor(0, 0, 255, 0.4645669291338583, $image->colorAt(0, 0));
        $this->assertColor(255, 0, 0, 1, $image->colorAt(1, 1));
        $this->assertColor(0, 0, 255, 0.4645669291338583, $image->colorAt(2, 2));
    }
}
