...
final class ResizeCanvasModifierTest extends GdTestCase
{
    ...
    public function testModifyWithTransparency(): void
    {
        ...
        $this->assertColor(255, 255, 0, 1, $image->colorAt(0, 0));
        $this->assertColor(180, 224, 0, 1, $image->colorAt(1, 1));
        $this->assertColor(180, 224, 0, 1, $image->colorAt(2, 2));
        $this->assertColor(255, 255, 0, 1, $image->colorAt(17, 17));
        ...
        $this->assertColor(0, 0, 255, 0.33070866141732286, $image->colorAt(5, 5));
        $this->assertColor(0, 0, 255, 0.33070866141732286, $image->colorAt(16, 5));
        $this->assertColor(0, 0, 255, 0.33070866141732286, $image->colorAt(30, 5));
        $this->assertColor(0, 0, 255, 0.33070866141732286, $image->colorAt(5, 16));
        $this->assertColor(255, 0, 0, 1, $image->colorAt(16, 16));
        $this->assertColor(0, 0, 255, 0.33070866141732286, $image->colorAt(30, 16));
        $this->assertColor(0, 0, 255, 0.33070866141732286, $image->colorAt(5, 30));
        $this->assertColor(0, 0, 255, 0.33070866141732286, $image->colorAt(16, 30));
        $this->assertColor(0, 0, 255, 0.33070866141732286, $image->colorAt(30, 30));
    }

    public function testModifyEdge(): void
    {
        $image = $this->createTestImage(1, 1);
        $this->assertColor(255, 0, 0, 1, $image->colorAt(0, 0));
        $image->modify(new ResizeCanvasModifier(null, 2, 'ff0', Alignment::BOTTOM));
        $this->assertEquals(1, $image->width());
        $this->assertEquals(2, $image->height());
        $this->assertColor(255, 255, 0, 1, $image->colorAt(0, 0));
        $this->assertColor(255, 0, 0, 1, $image->colorAt(0, 1));
    }
}
