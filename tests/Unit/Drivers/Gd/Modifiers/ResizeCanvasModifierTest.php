...
final class ResizeCanvasModifierTest extends GdTestCase
{
    ...
    public function testModifyWithTransparency(): void
    {
        ...
        $this->assertColor(0, 0, 255, 0.33070866141732286, $image->pickColor(5, 5));
        $this->assertColor(0, 0, 255, 0.33070866141732286, $image->pickColor(16, 5));
        $this->assertColor(0, 0, 255, 0.33070866141732286, $image->pickColor(30, 5));
        $this->assertColor(0, 0, 255, 0.33070866141732286, $image->pickColor(5, 16));
        $this->assertColor(255, 0, 0, 1, $image->pickColor(16, 16));
        $this->assertColor(0, 0, 255, 0.33070866141732286, $image->pickColor(30, 16));
        $this->assertColor(0, 0, 255, 0.33070866141732286, $image->pickColor(5, 30));
        $this->assertColor(0, 0, 255, 0.33070866141732286, $image->pickColor(16, 30));
        $this->assertColor(0, 0, 255, 0.33070866141732286, $image->pickColor(30, 30));
    }
    ...
    public function testModifyEdge(): void
    {
        ...
        $this->assertColor(255, 255, 0, 1, $image->pickColor(0, 0));
        $this->assertColor(255, 0, 0, 1, $image->pickColor(0, 1));
    }
}
