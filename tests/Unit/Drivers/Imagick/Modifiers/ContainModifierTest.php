...
final class ContainModifierTest extends ImagickTestCase
{
    public function testModify(): void
    {
        ...
        $this->assertColor(255, 255, 0, 1, $image->pickColor(175, 10));
        $this->assertEquals(200, $result->width());
        $this->assertEquals(100, $result->height());
        $this->assertColor(255, 255, 0, 1, $result->pickColor(0, 0));
        $this->assertColor(0, 0, 0, 0, $result->pickColor(140, 10));
        $this->assertColor(255, 255, 0, 1, $result->pickColor(175, 10));
    }
}
